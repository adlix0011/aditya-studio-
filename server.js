...
const server = http.createServer(async (req, res) => {
  ...
  const localDeliveryAssets = new Set([
    ...
    'post-wallet.js', 'language.js', 'notifications-page.js', 'notification-alerts.js', 'repost-order.js', 'messages-hub.js', 'chat-room.js', 'confirmation-wait.js', 'order-tracking.js', 'local-delivery-admin.js', 'local-delivery-admin.css'
  ]);
