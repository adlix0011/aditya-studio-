...
(function(){
  ...
  function show(n){sound();if(n.kind==='local-delivery-message')document.querySelector('.notification-bell i')?.classList.add('unread');if(window.Notification&&Notification.permission==='granted'){try{new Notification(n.title||'Local Delivery',{body:n.body||'नई update मिली है',tag:n.id,renotify:true})}catch(_){}}if(typeof toast==='function')toast('🔔 '+(n.title||'नई notification')+' — '+(n.body||''));}
