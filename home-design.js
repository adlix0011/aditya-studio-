...
(()=>{
 ...
 const row=(title,items)=>`<section style="margin-top:20px"><h2 style="margin:0 0 12px;color:#fff;font-size:22px">${title}</h2><div style="display:flex;gap:12px;overflow-x:auto;padding:3px 2px 14px">${items.map(card).join('')}</div></section>`;
